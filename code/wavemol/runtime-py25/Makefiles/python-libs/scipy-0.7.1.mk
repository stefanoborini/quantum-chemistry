...
$(SCIPY_TARGET): $(INIT_TARGET) $(DOWNLOAD_DIR)/$(SCIPY_PACKAGE) 
	...
	cd $(UNPACK_DIR)/scipy-$(SCIPY_VERSION); export PATH=$(RUNTIME_DIR)/bin:$$PATH PYTHONPATH=$(RUNTIME_DIR)/lib/python2.5/site-packages/; $(RUNTIME_DIR)/bin/python2.5 setup.py install --prefix=$(RUNTIME_DIR)
	touch $(SCIPY_TARGET)
endif
