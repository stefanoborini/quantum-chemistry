...
print "H "+str(12+number_of_units*4)+" "+str(11+number_of_units*4)+" roh "+str(9+number_of_units*4)+" 120. "+str(7+number_of_units*4)+" 180.0"
print "N "+str(13+number_of_units*4)+" 1 rcn 3 180.0 4 0.0"
print """[basis]
* 6-31G*
[symmetry]
X
