...
print "C "+str(11+number_of_units*4)+" "+str(9+number_of_units*4)+" rc1 "+str(7+number_of_units*4)+" 120. "+str(8+number_of_units*4)+" 0.0"
print "N "+str(12+number_of_units*4)+" "+str(11+number_of_units*4)+" rcn "+str(9+number_of_units*4)+" 180. "+str(10+number_of_units*4)+" 0.0"
print """[basis]
* 6-31G*
[symmetry]
X
