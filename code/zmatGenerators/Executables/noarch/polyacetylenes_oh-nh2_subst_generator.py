...
print "H "+str(12+number_of_units*4)+" "+str(11+number_of_units*4)+" rnh "+str(9+number_of_units*4)+" 120. "+str(10+number_of_units*4)+" 180.0"
print "H "+str(13+number_of_units*4)+" "+str(11+number_of_units*4)+" rnh "+str(9+number_of_units*4)+" 120. "+str(10+number_of_units*4)+" 0.0"
