...
# @description this script computes the second hyperpolarizabilities with HF wavefunction
...
def _usage():
    ...
    print ""
    print "Computes the second hyperpolarizabilities for a given dalton file, using a HF wavefunction"
    print ""
    print "Options:"
    print ""
    print "--x-only               : Computes only along the (X;X,X,X) component"
...
f.write("""# this file generated automatically by computeSecondHyperpol20090314.py
**DALTON
.RUN RESPONS
.DIRECT
**INTEGRALS
