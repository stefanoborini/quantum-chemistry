...
class TestTokens(unittest.TestCase):
    ...
    def testBondLengthsToken(self): # fold>>
        ...
        # <<fold
    def testBondLengthsPrimedToken(self): # fold>>
        data = FileSnippets.bondLengthsPrimed()
        writeToTestFile(data)
        ...
        self.assertEqual(token.atomList()[0][0][0], "C2")
        self.assertEqual(token.atomList()[0][0][1], "")
        self.assertEqual(token.atomList()[0][1][0], "H1")
        self.assertEqual(token.atomList()[0][1][1], "")
        self.assertEqual(token.atomList()[0][2].value(), 1.080593 )
        self.assertEqual(token.atomList()[0][2].unit(), Units.angstrom)

        self.assertEqual(token.atomList()[1][0][0], "C60'")
        self.assertEqual(token.atomList()[1][0][1], "")
        self.assertEqual(token.atomList()[1][1][0], "H59'")
        self.assertEqual(token.atomList()[1][1][1], "")
        self.assertEqual(token.atomList()[1][2].value(), 1.089678)
        self.assertEqual(token.atomList()[1][2].unit(), Units.angstrom)

        self.assertEqual(token.atomList()[2][0][0], "C60'")
        self.assertEqual(token.atomList()[2][0][1], "")
        self.assertEqual(token.atomList()[2][1][0], "C60")
        self.assertEqual(token.atomList()[2][1][1], "")
        self.assertEqual(token.atomList()[2][2].value(), 1.439997)
        self.assertEqual(token.atomList()[2][2].unit(), Units.angstrom)

        self.assertEqual(token.atomList()[3][0][0], "C58")
        self.assertEqual(token.atomList()[3][0][1], "")
        self.assertEqual(token.atomList()[3][1][0], "H57'")
        self.assertEqual(token.atomList()[3][1][1], "")
        self.assertEqual(token.atomList()[3][2].value(), 1.089720)
        self.assertEqual(token.atomList()[3][2].unit(), Units.angstrom)
