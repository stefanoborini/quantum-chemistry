...
print "O "+str(11+number_of_units*4)+" "+str(9+number_of_units*4)+" rco "+str(7+number_of_units*4)+" 120. "+str(8+number_of_units*4)+" 0.0"
print "H "+str(12+number_of_units*4)+" "+str(11+number_of_units*4)+" roh "+str(9+number_of_units*4)+" 120. "+str(10+number_of_units*4)+" 0.0"
print "H "+str(13+number_of_units*4)+" 1 roh 3 120.0 2 180.0"
print """[basis]
* 6-31G*
[symmetry]
X
