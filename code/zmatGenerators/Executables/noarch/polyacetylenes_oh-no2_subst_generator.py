...
print "O "+str(12+number_of_units*4)+" "+str(11+number_of_units*4)+" rno "+str(9+number_of_units*4)+" 120. "+str(10+number_of_units*4)+" 180.0"
print "O "+str(13+number_of_units*4)+" "+str(11+number_of_units*4)+" rno "+str(9+number_of_units*4)+" 120. "+str(10+number_of_units*4)+" 0.0"
print "H "+str(14+number_of_units*4)+" 1 roh 3 120.0 2 180.0"
print """[basis]
* 6-31G*
[symmetry]
X
