...
$(MATPLOTLIB_TARGET): $(INIT_TARGET) $(DOWNLOAD_DIR)/$(MATPLOTLIB_PACKAGE)
	...
	cd $(UNPACK_DIR)/matplotlib-$(MATPLOTLIB_VERSION); export PATH=$(RUNTIME_DIR)/bin:$$PATH LDFLAGS="$(LIBS):$(LDFLAGS)" CPPFLAGS="$(INCLUDES) -I$(RUNTIME_DIR)/include/freetype2/ $(CPPFLAGS)" PYTHONPATH=$(RUNTIME_DIR)/lib/python2.4/site-packages/; $(RUNTIME_DIR)/bin/python2.4 setup.py install --prefix=$(RUNTIME_DIR)
