...
print "N "+str(11+number_of_units*4)+" "+str(9+number_of_units*4)+" rcno2 "+str(7+number_of_units*4)+" 120. "+str(8+number_of_units*4)+" 0.0"
print "O "+str(12+number_of_units*4)+" "+str(11+number_of_units*4)+" rno "+str(9+number_of_units*4)+" 120. "+str(7+number_of_units*4)+" 0.0"
print "O "+str(13+number_of_units*4)+" "+str(11+number_of_units*4)+" rno "+str(9+number_of_units*4)+" 120. "+str(7+number_of_units*4)+" 180.0"

print "O "+str(14+number_of_units*4)+" 1 rno 3 120.0 4 180.0"
print "O "+str(15+number_of_units*4)+" 1 rno 3 120.0 4 0.0"
print """[basis]
* 6-31G*
[symmetry]
X
